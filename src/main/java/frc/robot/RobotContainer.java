  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      operatorXbox.povDown()
          .onTrue(Commands.runOnce(() -> elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L1_HEIGHT)));
      operatorXbox.povLeft()
          .onTrue(Commands.runOnce(() -> elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L2_HEIGHT)));
      operatorXbox.povRight()
          .onTrue(Commands.runOnce(() -> elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L3_HEIGHT)));
      operatorXbox.povUp()
          .onTrue(Commands.runOnce(() -> elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L4_HEIGHT)));

      operatorXbox.y().onTrue(Commands.runOnce(() -> elevatorSubsystem.setTargetPosition(0))); // Bottom Most Position
