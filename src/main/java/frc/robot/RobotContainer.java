...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                if (DriverStation.isTest()) {
                        ...
                        // .onTrue(Commands
                        // .runOnce(() ->
                        // elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L1_HEIGHT)));
                        // operatorXbox.povLeft()
                        // .onTrue(Commands
                        // .runOnce(() ->
                        // elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L2_HEIGHT)));
                        // operatorXbox.povRight()
                        // .onTrue(Commands
                        // .runOnce(() ->
                        // elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L3_HEIGHT)));
                        // operatorXbox.povUp()
                        // .onTrue(Commands
                        // .runOnce(() ->
                        // elevatorSubsystem.setTargetHeight(ElevatorConstants.CORAL_L4_HEIGHT)));

                        // operatorXbox.y().onTrue(Commands.runOnce(() ->
                        // elevatorSubsystem.setTargetPosition(0))); // Bottom Most
                        // // Position
                        ...
                        // Commands.runOnce(() ->
                        // grabberSubsystem.setTargetDirection(GrabDirection.OUTTAKE))))
                        ...
                        // Commands.runOnce(() -> grabberSubsystem.setTargetType(GrabType.CORAL)),
                        // Commands.runOnce(() ->
                        // grabberSubsystem.setTargetDirection(GrabDirection.INTAKE))))
                        // .whileTrue(new GrabberCommand(grabberSubsystem, false));
        ...
        private void configureDefaultCommands() {
                ...
                // grabberSubsystem.setDefaultCommand(new GrabberCommand(grabberSubsystem,
                // true));
        }
